 ...
 * Slug: osmium/header-tagline
 * Categories: header, osmium-headers
 * Block Types: core/template-part/header
 * Keywords: header, tagline, search, description, navigation
 * Description: Site title with the tagline beneath it on the left, and the navigation and a search button on the right. Set the tagline under Settings, General.
 * Viewport Width: 1400
 *
 * @package Osmium
 * @since 0.3.0
...
<!-- wp:search {"label":"<?php echo esc_attr__( 'Search', 'osmium' ); ?>","showLabel":false,"placeholder":"<?php echo esc_attr__( 'Search the site', 'osmium' ); ?>","buttonText":"<?php echo esc_attr__( 'Search', 'osmium' ); ?>","buttonPosition":"button-only","buttonUseIcon":true,"isSearchFieldHidden":true} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
